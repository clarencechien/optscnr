...
- **燈色怎麼讀**（2026-09-12 使用者問答，全文在 REVIEW_2026-07.md 末節）：紅燈＝該前提被資料反駁，管加碼不管出清；
  總判定 2 顆 RED 才 RED；M3/M9 觀察、M5/M8 敘事。「綠燈價格沒漲＝先行指標」是假說，
  n≥30 後開的實驗清單（燈色×價格交叉表、硬資料／敘事分開退役、觀察模組轉正條件）同在該節；之前不加、不調。
