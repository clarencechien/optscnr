...
SECTIONS = [
    ("tw_weekly.md", "（週報尚無輸出：tw_brief.py 在天氣台／delta 跑完後組裝）"),
    ("tw_scanner_briefing.md", "（天氣台今日簡報尚無輸出）"),
    ("delta_radar_report.md", "（delta radar 報告尚無輸出）"),
    ("tsmc_radar_report.md", None),          # 2330 論點監控（首跑後才有；缺了不佔位）
...
def main():
    md = "# 🇹🇼 台股雷達站（週報 + tw_scanner + delta_radar + tsmc_radar + DCA 影子帳本 + 賭場 sector）\n\n"
