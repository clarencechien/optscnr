...
_README 由 build_readme.py 於 2026-07-31 01:29 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-07-30 06:04 UTC
...
| M5 narrative_triggers | 🟢 GREEN | capex_cut:5e / vr300_delay:15e(19m) / debt_financed_capex:13e / lc_psu_competition:0e |
...
- 本次回填 **5** 筆；state 已有 outcomes 的 entry：**63/63**
