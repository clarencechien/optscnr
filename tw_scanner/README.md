...
_README 由 build_readme.py 於 2026-08-27 23:03 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# 🌤️ 台股 DCA 天氣簡報 — 2026-08-27

## 鋒面：⛅ **NEUTRAL** 　(score +0.37)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`+397,009,401,931`，落在近一年第 **100** 百分位
- 外資大台淨倉 Δ：`-1,182`，落在近一年第 **35** 百分位（水位 -84,836 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+4,400`，落在近一年第 **42** 百分位
- 融資餘額變化：`+5,116,199,000`，落在近一年第 **81** 百分位
