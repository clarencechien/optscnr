...
_README 由 build_readme.py 於 2026-08-24 14:24 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# 🌤️ 台股 DCA 天氣簡報 — 2026-08-24

## 鋒面：⛅ **NEUTRAL** 　(score -0.09)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`+154,040,284,439`，落在近一年第 **86** 百分位
- 外資大台淨倉 Δ：`+65`，落在近一年第 **53** 百分位（水位 -82,529 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+9,915`，落在近一年第 **77** 百分位
- 融資餘額變化：`-1,679,892,000`，落在近一年第 **19** 百分位
