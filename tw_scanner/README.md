...
_README 由 build_readme.py 於 2026-08-31 19:40 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-08-31 09:58 UTC
...
| M5 narrative_triggers | 🟢 GREEN | capex_cut:4e / vr300_delay:10e / debt_financed_capex:14e / lc_psu_competition:0e |
...
- 本次回填 **1** 筆；state 已有 outcomes 的 entry：**93/93**
