...
_README 由 build_readme.py 於 2026-08-20 14:19 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# 🌤️ 台股 DCA 天氣簡報 — 2026-08-20

## 鋒面：⛅ **NEUTRAL** 　(score -0.12)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`+88,560,755,344`，落在近一年第 **79** 百分位
- 外資大台淨倉 Δ：`-922`，落在近一年第 **39** 百分位（水位 -82,423 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+9,158`，落在近一年第 **73** 百分位
- 融資餘額變化：`+217,387,000`，落在近一年第 **31** 百分位
