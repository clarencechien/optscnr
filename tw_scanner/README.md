...
_README 由 build_readme.py 於 2026-09-10 17:16 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-09-10 09:14 UTC
...
- 本次回填 **1** 筆；state 已有 outcomes 的 entry：**101/101**
