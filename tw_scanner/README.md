...
_README 由 build_readme.py 於 2026-08-05 15:49 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# 🌤️ 台股 DCA 天氣簡報 — 2026-08-05

## 鋒面：🥶 **CAPITULATION** 　(score -0.13)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`-458,851,764,505`，落在近一年第 **16** 百分位
- 外資大台淨倉 Δ：`+659`，落在近一年第 **62** 百分位（水位 -87,199 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+6,284`，落在近一年第 **60** 百分位
- 融資餘額變化：`+2,357,656,000`，落在近一年第 **56** 百分位
