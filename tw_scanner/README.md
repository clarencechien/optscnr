...
_README 由 build_readme.py 於 2026-08-20 04:04 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-08-20 04:04 UTC
...
| M5 narrative_triggers | 🔴 RED | capex_cut:8e / vr300_delay:14e(17m) / debt_financed_capex:12e / lc_psu_competition:0e |
...
- 本次回填 **5** 筆；state 已有 outcomes 的 entry：**85/85**
