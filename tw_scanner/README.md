...
_README 由 build_readme.py 於 2026-08-17 14:04 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-08-17 04:09 UTC
...
| M5 narrative_triggers | 🟡 YELLOW | capex_cut:6e(7m) / vr300_delay:15e(18m) / debt_financed_capex:13e / lc_psu_competition:0e |
...
- 本次回填 **1** 筆；state 已有 outcomes 的 entry：**82/82**
