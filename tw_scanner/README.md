...
_README 由 build_readme.py 於 2026-08-07 04:35 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# 🌤️ 台股 DCA 天氣簡報 — 2026-08-06

## 鋒面：🥶 **CAPITULATION** 　(score -0.25)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`-418,882,958,376`，落在近一年第 **17** 百分位
- 外資大台淨倉 Δ：`-2,184`，落在近一年第 **23** 百分位（水位 -89,383 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+10,784`，落在近一年第 **83** 百分位
- 融資餘額變化：`+9,312,660,000`，落在近一年第 **94** 百分位
