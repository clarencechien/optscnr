...
_README 由 build_readme.py 於 2026-09-03 08:17 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
# Delta Radar (2308.TW) — 2026-09-03 08:17 UTC
...
| M5 narrative_triggers | 🟢 GREEN | capex_cut:3e / vr300_delay:18e(21m) / debt_financed_capex:13e(14m) / lc_psu_competition:0e |
...
- [capex_cut] 'The odd decouple': JPMorgan says the tech capex surge is masking a troubling slowdown in job growth - businessinsider.c
...
- 本次回填 **1** 筆；state 已有 outcomes 的 entry：**96/96**
