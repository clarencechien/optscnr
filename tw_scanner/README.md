...
_README 由 build_readme.py 於 2026-09-22 17:47 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
- 鋒面 ☀️ RISK_ON（本週未變）。
- 2308 前提 🔴 RED；🔀 反向背離：前提轉紅、價格 20 日 +11.1% 未跌 —— 市場不買儀器的帳，或儀器誤判；PER 55.2，3 年分位 79 → 78
...
- 🔀 反向背離：前提轉紅、價格 20 日 +11.1% 未跌 —— 市場不買儀器的帳，或儀器誤判；PER 55.2，3 年分位 79 → 78
...
- 2026-10-10（18 天後）台股月營收公告截止（2330／2308 通常 10 日前後）

## 6. 資料健康

- ✅ 天氣台：最新 2026-09-22
- ✅ DCA 帳本：最新 2026-09-22
- ✅ delta_radar：最新 2026-09-22
- ✅ tsmc_radar：最新 2026-09-22
- ✅ 賭場 sector：最新 2026-09-22

---
*tw_brief — 週報：規則影子帳本＋溫度計＋2308／2330 論點監控＋賭場 sector。沒有任何一行是買賣建議；曝險與部位由人管。 產出 2026-09-22T17:47:04+00:00*

---

# 🌤️ 台股 DCA 天氣簡報 — 2026-09-22

## 鋒面：☀️ **RISK_ON** 　(score +0.11)

## 溫度計（全部為 Δ 與滾動分位數，無絕對閾值）
- 外資現貨 20 日累積：`+98,721,598,493`，落在近一年第 **76** 百分位
- 外資大台淨倉 Δ：`-1,487`，落在近一年第 **31** 百分位（水位 -75,568 口僅供參考，不參與判讀）
- 散戶小台淨倉：`+2,912`，落在近一年第 **32** 百分位
- 融資餘額變化：`+1,823,637,000`，落在近一年第 **47** 百分位
...
# Delta Radar (2308.TW) — 2026-09-22 07:56 UTC

## 總判定：⚪ PARTIAL（僅跑 m5）｜模組色僅供參考 🟢 GREEN

## 🔀 前提 vs 價格：🔀 反向背離：前提轉紅、價格 20 日 +11.1% 未跌 —— 市場不買儀器的帳，或儀器誤判；PER 55.2，3 年分位 79 → 78
...
- 本次回填 **4** 筆；state 已有 outcomes 的 entry：**116/116**
...
| M5 | 29 / -2.68 | 48 / -9.72 | 39 | 累積中（GREEN n=29 < 30）；方向對 |
...
# 💰 DCA 規則影子帳本（0050）— 至 2026-09-22

每月 6 日後首個交易日買 10,000 元；價格 2019-01-02 起、鋒面/警報序列 2019-01-02 起（1876 日）。等額假設、不記真實部位。
...
## 視窗：full（2019-01-02 → 2026-09-22，93 期）

| 規則 | 買次 | 投入 | 單位 | 平均成本 | vs 純 DCA | 期末市值 | 報酬 | XIRR |
|---|---|---|---|---|---|---|---|---|
| 純定期定額 | 93 | 930,000 | 28,521.02 | 32.61 | +0.00% | 3,190,076 | +243.02% | +31.22% |
| 週檢查・月預算・投降窗即刻投入 | 93 | 990,000 | 29,939.75 | 33.07 | +1.41% | 3,348,762 | +238.26% | +31.67% |
| 定期定額＋投降窗加碼 | 101 | 1,010,000 | 30,753.05 | 32.84 | +0.71% | 3,439,728 | +240.57% | +31.39% |
| 定期定額＋鋒面調節 | 93 | 1,015,000 | 30,958.32 | 32.79 | +0.55% | 3,462,688 | +241.15% | +31.17% |
| 對照：一次投入 | 1 | 930,000 | 50,261.25 | 18.50 | -43.27% | 5,621,721 | +504.49% | +26.27% |
...
## 視窗：last_12m（2025-09-22 → 2026-09-22，12 期）

| 規則 | 買次 | 投入 | 單位 | 平均成本 | vs 純 DCA | 期末市值 | 報酬 | XIRR |
|---|---|---|---|---|---|---|---|---|
| 純定期定額 | 12 | 120,000 | 1,503.48 | 79.81 | +0.00% | 168,164 | +40.14% | +89.47% |
| 週檢查・月預算・投降窗即刻投入 | 13 | 150,000 | 1,893.08 | 79.24 | -0.71% | 211,741 | +41.16% | +92.77% |
| 定期定額＋投降窗加碼 | 14 | 140,000 | 1,707.82 | 81.98 | +2.72% | 191,019 | +36.44% | +90.84% |
| 定期定額＋鋒面調節 | 12 | 140,000 | 1,724.78 | 81.17 | +1.70% | 192,916 | +37.80% | +89.26% |
| 對照：一次投入 | 1 | 120,000 | 1,943.23 | 61.75 | -22.63% | 217,350 | +81.13% | +85.80% |
...
# 🎰 賭場 sector — AI 個股影子追蹤（2026-09-22）
...
|---|---|---|---|---|---|---|---|---|---|
| 3661 | 世芯-KY | ASIC |  | 3715.0 | -3.9% | -11.0% | +273.6% | +156.9% | +129.1 |
| 2382 | 廣達 | 機櫃 | ✓ | 342.0 | +4.1% | -3.0% | +177.5% | +137.2% | +37.3 |
| 2383 | 台光電 | CCL | ✓ | 4860.0 | -13.1% | -20.3% | +129.8% | +126.6% | +4.6 |
| 3443 | 創意 | ASIC |  | 8375.0 | +50.4% | +43.2% | +111.0% | +124.4% | +3.6 |
| 3231 | 緯創 | 機櫃 | ✓ | 180.5 | +1.1% | -6.0% | +166.5% | +93.7% | +56.3 |
| 3324 | 雙鴻 | 散熱 |  | 1600.0 | +50.2% | +43.1% | +67.2% | +82.0% | +2.5 |
| 2345 | 智邦 | 網通 | ✓ | 1915.0 | -5.7% | -12.8% | +59.4% | +64.1% | -0.9 |
| 3017 | 奇鋐 | 散熱 | ✓ | 3390.0 | +14.9% | +7.8% | +54.3% | +59.3% | -5.9 |
| 2330 | 台積電 | 製造 | ✓ | 2460.0 | +2.5% | -4.6% | +53.3% | +55.3% | -7.3 |
| 2317 | 鴻海 | 機櫃 | ✓ | 253.0 | +4.1% | -3.0% | +52.0% | +52.8% | -0.1 |
| 2308 | 台達電 | 電力 | ✓ | 1900.0 | +11.1% | +4.0% | +34.9% | +46.0% | -10.2 |
| 3037 | 欣興 | 載板 | ✓ | 1120.0 | +2.3% | -4.9% | +56.3% | +45.4% | +10.0 |
| 3711 | 日月光投控 | 封測 | ✓ | 693.0 | +17.3% | +10.1% | +45.7% | +40.6% | +6.4 |
| 6669 | 緯穎 | 機櫃 | ✓ | 2115.0 | -1.5% | -8.6% | +50.4% | +39.8% | +10.3 |
| 2301 | 光寶科 | 電源 | ✓ | 284.5 | -3.9% | -11.0% | +25.2% | +33.3% | -5.9 |
| 2454 | 聯發科 | IC設計 | ✓ | 5180.0 | +38.7% | +31.6% | +44.1% | +19.7% | +20.6 |

## 影子 DCA：每月等權買整籃 vs 同一筆錢買 0050

- 2024-01-08 起 33 個月、投入 165,000 元（16 檔等權）
- 籃子市值 519,043（+214.6%）；0050 市值 351,349（+112.9%）；差 **+101.6 pp**
- 判準狀態：可讀

## 月營收 3 月均 YoY 三分位 vs T+20 對 0050 超額（只印不裁決）

- 累積中（state 128 筆、已回填 T+20 0 筆）
