...
_README 由 build_readme.py 於 2026-09-14 18:54 UTC 重組；兩區塊各為該雷達最近一次排程的輸出，時間戳以區塊內為準。_
...
- 🔀 背離：前提健在（YELLOW）、價格 20 日 -14.1% —— 跌的是估值不是基本面（或市場知道儀器不知道的事）；PER 51.6，3 年分位 83 → 74
  ...
  - 🟢 M5 narrative_triggers：capex_cut:4e / vr300_delay:19e(21m) / debt_financed_capex:10e(11m) / lc_psu_competition:0e
...
- 2026-10-10（26 天後）台股月營收公告截止（2330／2308 通常 10 日前後）
...
---
*tw_brief — 週報：規則影子帳本＋溫度計＋2308／2330 論點監控＋賭場 sector。沒有任何一行是買賣建議；曝險與部位由人管。 產出 2026-09-14T18:54:25+00:00*
...
# Delta Radar (2308.TW) — 2026-09-14 09:15 UTC

## 總判定：🟡 YELLOW

## 🔀 前提 vs 價格：🔀 背離：前提健在（YELLOW）、價格 20 日 -14.1% —— 跌的是估值不是基本面（或市場知道儀器不知道的事）；PER 51.6，3 年分位 83 → 74
...
| M9 valuation（觀察） | 🟢 GREEN | PER 51.6（3 年第 74 百分位；20 日前第 83）；觀察 |
...
- 本次回填 **1** 筆；state 已有 outcomes 的 entry：**108/108**
